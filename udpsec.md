...
- [dnscrypt-proxy-installer](https://github.com/DNSCrypt/dnscrypt-proxy-installer) - Linux installer for dnscrypt-proxy
...
- [Aoba](https://github.com/luyilin/Aoba) - Create a lovely resume more easily.
