...
- [uxss-db](https://github.com/Metnew/uxss-db) - 🔪Browsers vulnerabilities DB :skull_and_crossbones:
...
- [DomainRecon](https://github.com/x73x61x6ex6ax61x79/DomainRecon) - Based on URL, collect the subdomains using various tools like Sublist3r, recon-ng etc.. And check for subdomain take over and Run the EyeWitness to take the screenshot of all the found subdomains.
...
- [TopHat](https://github.com/Eitenne/TopHat) - Fully undetected backdoor with RSA Encrypted shell
...
- [Minesweeper](https://github.com/codingo/Minesweeper) - A Burpsuite plugin (BApp) to aid in the detection of scripts being loaded from over 5600 malicious cryptocurrency mining domains (cryptojacking).
